  ...
  window.needShareButton = function (elem, options) {
    ...
    root.share = {
      ...
      "wechat": function (el) {
        ...
        spanEl.setAttribute("class", "need-share-wechat-code-desc");
        spanEl.innerHTML = "使用手机微信扫码查看文章";
        if (img) {
          img.remove();
          spanEl.remove();
        } else {
    ...
    document.addEventListener("click", function (event) {
      ...
      if (!closest(event.target, ".need-share-button-opened")) {
        if (openedEl) {
          ...
          if (openedEl.querySelector(".need-share-wechat-code-desc")) {
            openedEl.querySelector(".need-share-wechat-code-desc").remove();
          }
        } else {
